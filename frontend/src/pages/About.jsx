  ...
  return (
    <div>
      ...
      <section className="bg-white rounded-xl border border-slate-200 shadow-sm p-6 mb-6">
                <h2 className="text-base font-semibold text-[#29332D] mb-2">Project Overview</h2>
      ...
      <section className="bg-white rounded-xl border border-slate-200 shadow-sm p-6 mb-6">
        <div className="flex items-center gap-2 mb-4">
          ...
          <h2 className="text-base font-semibold text-[#29332D]">Project Objectives</h2>
        </div>
        <ul className="grid grid-cols-1 sm:grid-cols-2 gap-3">
          {objectives.map((obj) => (
            <li key={obj} className="flex items-start gap-2 text-sm text-[#6B756F]">
      ...
      <section className="bg-white rounded-xl border border-slate-200 shadow-sm p-6 mb-6">
                <h2 className="text-base font-semibold text-[#29332D] mb-5">System Workflow</h2>
        <div className="flex flex-col items-center gap-2">
          {workflowSteps.map((step, idx) => (
            <div key={step} className="flex flex-col items-center gap-2 w-full sm:w-auto">
              ...
              {idx < workflowSteps.length - 1 && <ArrowDownIcon className="h-4 w-4 text-[#8FAF94]" />}
            </div>
          ))}
        </div>
      </section>
      ...
      <section className="bg-white rounded-xl border border-slate-200 shadow-sm p-6 mb-6">
        <div className="flex items-center gap-2 mb-3">
          ...
          <h2 className="text-base font-semibold text-[#29332D]">Dataset</h2>
        </div>
      ...
      <section className="bg-white rounded-xl border border-slate-200 shadow-sm p-6 mb-6">
        <div className="flex items-center gap-2 mb-4">
          ...
          <h2 className="text-base font-semibold text-[#29332D]">Technology Stack</h2>
        </div>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          {techStack.map((group) => (
            <div key={group.category} className="rounded-lg border border-[#DCE3DA] p-4">
              <p className="text-xs font-semibold text-[#6B756F] uppercase tracking-wide mb-2">{group.category}</p>
              <div className="flex flex-wrap gap-2">
                {group.items.map((item) => (
                  <span key={item} className="px-2.5 py-1 rounded-md bg-[#E8F0E9] text-[#3A7D7C] text-xs font-medium">
                    {item}
                  </span>
                ))}
              </div>
      ...
      <section className="bg-white rounded-xl border border-slate-200 shadow-sm p-6 mb-6">
        <div className="flex items-center gap-2 mb-3">
          ...
          <h2 className="text-base font-semibold text-[#29332D]">SDG Alignment</h2>
        </div>
        <p className="text-sm text-[#6B756F] leading-relaxed">
      ...
      <section className="bg-white rounded-xl border border-slate-200 shadow-sm p-6 mb-6">
        <div className="flex items-center gap-2 mb-4">
          ...
          <h2 className="text-base font-semibold text-[#29332D]">Limitations</h2>
        </div>
        <ul className="space-y-2">
          {limitations.map((lim) => (
            <li key={lim} className="flex items-start gap-2 text-sm text-[#6B756F]">
              <span className="mt-1.5 h-1.5 w-1.5 rounded-full bg-[#C99A4A] shrink-0" />              {lim}
            </li>
          ))}
        </ul>
      </section>
      ...
      <section className="bg-white rounded-xl border border-slate-200 shadow-sm p-6">
        <div className="flex items-center gap-2 mb-4">
          ...
          <h2 className="text-base font-semibold text-[#29332D]">Future Enhancements</h2>
        </div>
        <ul className="space-y-2">
          {futureEnhancements.map((item) => (
            <li key={item} className="flex items-start gap-2 text-sm text-[#6B756F]">
              <span className="mt-1.5 h-1.5 w-1.5 rounded-full bg-[#6B8F71] shrink-0" />
              {item}
            </li>
          ))}
